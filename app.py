...
def login():
	...
	if method == 'GET':
		...
		conn = pymysql.connect(
			host='final-rds.cyrrvslwkevp.us-west-1.rds.amazonaws.com', user='admin', password='qwer1234',
...
def index():
    conn = pymysql.connect(host='final-rds.cyrrvslwkevp.us-west-1.rds.amazonaws.com', user='admin', password='qwer1234', db='nono', charset='utf8')
